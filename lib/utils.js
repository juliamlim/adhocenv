 ...
 * @returns Camel case string
 */
camelToScreaming = (str) => {
  return typeof str === 'string' ? str.replace(/([a-z])([A-Z])/g, '$1_$2').toUpperCase() : null;
}
...
module.exports = { arrayify, log, text, die, cmdText, camelToScreaming, kebabToCamel, parseString };
