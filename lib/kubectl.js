 ...
 */
yamlApply = (path, parse = false) => {
  return new Promise((resolve) => {

    // Grab string from template file
    let str = readFileSync(path, 'utf8').toString();
    ...
    // Create tmp file
    writeFileSync('tmp.yaml', data, { encoding: 'utf-8' });
 ...
 * @returns {Object}
 */
ingressRule = (paths, host, namespace) => {
...
/**
 * Additional config for the ingress server
 *
 * @returns {String}
 */
nginxServerSnippet = () => {
